...
namespace InCome
{
	...
	public class fmAdminLog : System.Windows.Forms.Form
	{
		...
		{
			System.Resources.ResourceManager resources = new System.Resources.ResourceManager(typeof(fmAdminLog));
			...
			this.bntSetPassword.Text = "Принять новый пароль";
			...
			this.btnCancelNewPassword.Text = "Отмена";
		...
		private void btnLog_Click(object sender, System.EventArgs e)
		{
			...
			if((tbPassword.Text!="") && (fdcr.conStr.IndexOf("Password="+tbPassword.Text+";")>=0)) 
			{
				isLog=true;
				Close();
			}
