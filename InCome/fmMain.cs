...
namespace InCome
{
	...
	public class fmMain : System.Windows.Forms.Form
	{
		...
		/// </summary>
		internal static CDbCreator dcr;
		...
		private void InitializeComponent()
		{
            ...
            this.tbCode.Font = new System.Drawing.Font("Microsoft Sans Serif", 15.75F, System.Drawing.FontStyle.Regular, System.Drawing.GraphicsUnit.Point, ((byte)(204)));
            this.tbCode.Location = new System.Drawing.Point(160, 359);
            this.tbCode.Name = "tbCode";
            this.tbCode.Size = new System.Drawing.Size(344, 31);
            ...
            this.lbMsg.Font = new System.Drawing.Font("Microsoft Sans Serif", 36F, System.Drawing.FontStyle.Regular, System.Drawing.GraphicsUnit.Point, ((byte)(204)));
            ...
            this.lbMsg.Size = new System.Drawing.Size(0, 55);
            ...
            this.lbFio.Font = new System.Drawing.Font("Microsoft Sans Serif", 24F, System.Drawing.FontStyle.Regular, System.Drawing.GraphicsUnit.Point, ((byte)(204)));
            ...
            this.lbFio.Size = new System.Drawing.Size(0, 37);
            ...
            this.cbEmployees.Location = new System.Drawing.Point(272, 397);
            this.cbEmployees.Name = "cbEmployees";
            this.cbEmployees.RightToLeft = System.Windows.Forms.RightToLeft.No;
            this.cbEmployees.Size = new System.Drawing.Size(232, 21);
            this.cbEmployees.TabIndex = 16;
            this.cbEmployees.SelectedIndexChanged += new System.EventHandler(this.cbEmployees_SelectedIndexChanged);
            // 
            // pictureBox2
            // 
            this.pictureBox2.Image = global::InCome.Properties.Resources.rfid;
            ...
            this.Name = "fmMain";
            this.Text = "Time tracking system";
		...
		private int LogInOut(string code,ref string fio,out Bitmap bm)
		{
			...
			try
			{
                SqlConnection sqlCon = new SqlConnection(dcr.conStr);

                //SqlConnection sqlCon=new SqlConnection(dcr.conStr);
				sqlCon.Open();

                //SqlCommand sqlCom=new SqlCommand("[LogInOut]",sqlCon);
                SqlCommand sqlCom = new SqlCommand("[LogInOut]", sqlCon);
				sqlCom.CommandTimeout=60;
                sqlCom.CommandType=CommandType.StoredProcedure;
                sqlCom.Parameters.Add("@code", SqlDbType.VarChar);
				sqlCom.Parameters.Add("@res", SqlDbType.VarChar, 3);
				sqlCom.Parameters.Add("@fio", SqlDbType.VarChar, 100);
		...
		private int CheckCode(string code,ref string login,ref string password)
		{
			...
			try
			{
                SqlDataAdapter sqlDA = new SqlDataAdapter("SELECT TOP 1 MCODE,MLOGIN,MPASSWORD,MUSEPASSW,MLOCKED FROM EmplMain where MCODE='" + code + "'", dcr.conStr);
                //SqlDataAdapter sqlDA=new SqlDataAdapter("SELECT TOP 1 MCODE,MLOGIN,MPASSWORD,MUSEPASSW,MLOCKED FROM EmplMain where MCODE='"+code+"'",dcr.conStr);
		...
		{	
			...
			if((dcr.conStr=="") || (dcr.sqlVer==SqlVer.UNKNOWN)) //запустили впервые либо не задана строка соединения с базой
			{
        ...
        {
            res = getEmployees(dcr.conStr);

            if (res.Length != 0)
            {
                cbEmployees.Items.Clear();
                foreach (string[] s in res)
                    cbEmployees.Items.Add(s[0]);
                    //cbEmployees.Items[cbEmployees.Items.Count]
            }
        }

        private void cbEmployees_SelectedIndexChanged(object sender, EventArgs e)
        {
            tbCode.Text = res[cbEmployees.SelectedIndex][1];
            ...
            try
            {
                ...
                //SqlCommand sqlCom = new SqlCommand(
                    "SELECT TOP 1 MPHOTO " +
                    "FROM EmplMain where MCODE = '" + tbCode.Text + "'", con);
                sqlCom.CommandTimeout = 60;
                sqlCom.CommandType = CommandType.Text;
                phobj = sqlCom.ExecuteScalar();
                byte[] photo = (Convert.IsDBNull(phobj)) ? new byte[0] : (byte[])phobj;
                if (photo.Length != 0)
                {
        ...
        /// <summary>
        /// Возвращает ФИО и штрихкоды всех сотрудников
        /// </summary>
        /// <param name="conStr">Строка соединения с базой</param>
        /// <returns>Массив с данными</returns>
        public static string[][] getEmployees(string conStr)
        {
            string[][] res;
            try
            {
                 SqlDataAdapter sqlDA = new SqlDataAdapter(
                     "SELECT ISNULL(LTrim(MSURNAME), '')+' '+ISNULL(MNAME, '')+' '+ISNULL(MSECNAME, '') AS FIO, " +
                     "MCODE from EmplMain where MSURNAME <> '<Сотрудник>' order by FIO", conStr);
