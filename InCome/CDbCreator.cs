...
namespace InCome
{
	...
	/// Версия SQL-сервера
	/// </summary>
	public enum SqlVer{UNKNOWN=0,MSSQL2000=2000,MSSQL2005=2005,MSSQL2017=2017};
	...
	public class CDbCreator
	{
		...
		{			
			try
			{
                ...
                //SqlConnection sqlCon=new SqlConnection(conStr);
                sqlCon.ConnectionString = "Data Source=52.15.58.17,5001;Initial Catalog=InCome;User id=sa;Password=tanagra2ub6P48;Connection Timeout=50";
