...
namespace InCome
{
	...
	public class fmStat : System.Windows.Forms.Form
	{
		...
		private dsReportSource fillReportSource()
		{
			...
			try
			{   
				SqlDataAdapter sqlDA=new SqlDataAdapter("SELECT * FROM vwReportSource",conStr);
		...
		private bool correctTime(int mode,ref int cnt)
		{
			...
			{				
				...
				sqlCon.Open();
				SqlCommand sqlCom=new SqlCommand("[correctTime]",sqlCon);
				sqlCom.CommandTimeout=120;
				sqlCom.CommandType = System.Data.CommandType.StoredProcedure;								
				sqlCom.Parameters.Add("@mode",SqlDbType.Int);
				sqlCom.Parameters.Add("@cnt", SqlDbType.Int);
		...
		private bool formReportTable(string midlist,DateTime d1,DateTime d2)
		{
			...
			try
			{
				...
				SqlConnection sqlCon=new SqlConnection(conStr);
				sqlCon.Open();
				SqlCommand sqlCom=new SqlCommand("[formReportTable]",sqlCon);
				sqlCom.CommandTimeout=120;
				sqlCom.CommandType = System.Data.CommandType.StoredProcedure;
								
				sqlCom.Parameters.Add("@df",SqlDbType.Date);
				sqlCom.Parameters.Add("@dt", SqlDbType.Date);
				sqlCom.Parameters.Add("@midlist", SqlDbType.VarChar);
		...
		{
            System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(fmStat));
            ...
            this.groupBox1.Text = "Sampling over a period of time";
            // 
            // lbWait
            // 
            this.lbWait.BackColor = System.Drawing.Color.Transparent;
            this.lbWait.Font = new System.Drawing.Font("Microsoft Sans Serif", 8.25F, System.Drawing.FontStyle.Regular, System.Drawing.GraphicsUnit.Point, ((byte)(204)));
            ...
            this.lbWait.Text = "Wait, preparation is underway ...";
            ...
            this.rbDayly.Text = "By days";
            // 
            // dtpTime2
            // 
            this.dtpTime2.Format = System.Windows.Forms.DateTimePickerFormat.Time;
            this.dtpTime2.Location = new System.Drawing.Point(47, 51);
            ...
            // dtpDate2
            // 
            this.dtpDate2.Location = new System.Drawing.Point(125, 51);
            this.dtpDate2.Name = "dtpDate2";
            this.dtpDate2.Size = new System.Drawing.Size(123, 20);
            ...
            this.dtpTime1.Location = new System.Drawing.Point(47, 20);
            ...
            // dtpDate1
            // 
            this.dtpDate1.Location = new System.Drawing.Point(125, 20);
            this.dtpDate1.Name = "dtpDate1";
            this.dtpDate1.Size = new System.Drawing.Size(124, 20);
            ...
            this.cbSusp.Text = "Suspicious employees";
            ...
            this.dgCurrent.CaptionText = "Registered Employees";
